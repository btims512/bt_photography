...
export default function MobileRail({ photos, onOpen }: MobileRailProps) {
  ...
  const edgeFromLeft = useTransform(smoothProgress, [0, 0.12, 0.72, 0.82, 0.88, 1], [1, 1, 0, 0, 1, 1]);
  const edgeFromRight = useTransform(smoothProgress, [0, 0.12, 0.72, 0.82, 0.88, 1], [-1, -1, 0, 0, -1, -1]);

...
export default function MobileRail({ photos, onOpen }: MobileRailProps) {
  ...
  const edgeFromLeft = useTransform(smoothProgress, [0, 0.12, 0.38, 0.62, 0.88, 1], [0.75, 0.75, 0, 0, 0.75, 0.75]);
  const edgeFromRight = useTransform(smoothProgress, [0, 0.12, 0.38, 0.62, 0.88, 1], [-1, -1, -0.25, -0.25, -1, -1]);

 ...
 * photo: there are 17 vertical photos, the three rails want 15 between
 * them, and the three pinned below are why the third rail runs to four
 * rather than five. Horizontal photos cost nothing - pin as many as you
 * like. (Shape, not section: a photo filed under comedy can still be rail
 * supply.)
 */
...
export const featuredPhotos: Photo[] = [
  ...
  { src: '/photos/portrait-14.jpg', alt: 'Woman in a leopard-print bodysuit and sunglasses crouching in front of a graffiti mural, glancing back over her shoulder', width: 3924, height: 5878, category: 'portraits' },
...
export const portraitPhotos: Photo[] = [
  ...
  { src: '/photos/portrait-14.jpg', alt: 'Woman in a leopard-print bodysuit and sunglasses crouching in front of a graffiti mural, glancing back over her shoulder', width: 3924, height: 5878 },

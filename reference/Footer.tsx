...
/**
 * 80px top padding, 60px bottom, everything centered, 14px type at 1.2
 * line-height. One social glyph, then two short lines. That is the whole
 * footer on the reference — resist adding columns to it.
 */
